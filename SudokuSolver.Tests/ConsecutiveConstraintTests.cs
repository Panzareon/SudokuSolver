	...
	public class ConsecutiveConstraintTests
	{
		...
		public void SimpleConstraintOn9Test()
		{
			...
			var board = Board.Parse(
				...
				61  2  4  
				""");
			var solver = new BoardSolver(board, [new DefaultSudoku(), new ConsecutiveConstraint(new Position(1, 6), new Position(0, 6))]);
		...
		public void SimpleConstraintOn7Test()
		{
			...
			var board = Board.Parse(
				...
				613827549
				""");
			var solver = new BoardSolver(board, [new DefaultSudoku(), new ConsecutiveConstraint(new Position(3, 3), new Position(2, 3))]);
