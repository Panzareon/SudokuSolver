	...
	public class ComplexSudokuTests : PerformanceTestsBase
	{
		...
		public void Tetrafolium()
		{
			...
			this.Test(board,
				...
				new SumConstraint(x => x % 2 == 1, new Position(3, 0), new Position(4, 0), new Position(5,0)),
				...
				new SumConstraint(x => x % 2 == 1, new Position(0, 3), new Position(0, 4), new Position(0, 5)),
				...
				new SumConstraint(x => x % 2 == 1, new Position(8, 3), new Position(8, 4), new Position(8, 5)),
